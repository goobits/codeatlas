...
use crate::typescript::parser::DynamicDependencyTarget;
use anyhow::Result;
...
pub(crate) use paths::is_declaration_file;
pub use paths::resolve_relative_module;
...
impl ModuleResolver {
    ...
    pub(super) fn resolve_dynamic(
        ...
        kind: crate::typescript::parser::DynamicDependencyKind,
    ) -> Vec<Resolution> {
        match target {
            DynamicDependencyTarget::Literal(specifier) => {
                if matches!(
                    kind,
                    crate::typescript::parser::DynamicDependencyKind::RuntimeFile
                        | crate::typescript::parser::DynamicDependencyKind::RuntimeProcess
                ) {
                ...
                if kind == crate::typescript::parser::DynamicDependencyKind::ImportScripts
