...
pub fn reachable_symbol_ids_by_entrypoint(
    root_dir: &Path,
    entrypoints: &[String],
...
pub fn reachable_symbol_ids_for_exports(
    root_dir: &Path,
    entrypoint: &str,
...
pub fn referenced_identifiers(symbol: &Symbol) -> BTreeSet<String> {
...
pub fn referenced_namespace_members(symbol: &Symbol, namespace: &str) -> BTreeSet<String> {
