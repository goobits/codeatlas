...
pub struct PythonReachabilityFacts {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PythonScopedImport {
    pub owner: String,
    pub import: PythonImport,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PythonDynamicDependency {
...
pub enum PythonUncertaintyKind {
    DynamicImport,
    Reflection,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PythonUncertainty {
    pub owner: Option<String>,
