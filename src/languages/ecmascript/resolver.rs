...
use paths::{
    has_resource_query, infer_workspace_root, is_bounded_local_pattern,
    is_generated_package_export, is_generated_source_path, is_non_source_specifier,
    is_relative_specifier, is_sveltekit_virtual, module_candidates, nearest_sveltekit_source_root,
    source_path_specifier, source_resolution, unsupported_relative_specifier,
